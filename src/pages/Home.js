...
export default function Home() {
  ...
  const dados = [
    {
      id: "1",
      component: <Img caminhoImg={img2} txt="Holambra-SP" nameFunction={"Holambra"} nomecidade={" cidade encantadora, fica a 120km de São Paulo, conhecida como cidade das flores, foi fundada por imigrantes holandeses e seu nome vem da junção Holanda, América e Brasil !"} />,
    },
    {
      id: "2",
    ...
    { id: "4", component: <Img caminhoImg={img4} txt="Ilhabela-SP" nameFunction={"Ilhabela"}nomecidade={" As condições de vento e mar do canal de São Sebastião fizeram Ilhabela ficar conhecida como a capital da vela. Diversas competições trazem velejadores do Brasil e de diversas partes do mundo. O nome Ilhabela foi dado por Américo Vespúcio descobriu esse arquipélago, o explorador disse que o destino poderia ser o mais próximo de qualquer paraíso na terra"} /> },
